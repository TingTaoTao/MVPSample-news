...
import com.lauren.simplenews.image.widget.ImageFragment;
...
import com.lauren.simplenews.weather.widget.WeaterFragment;
...
public class MainActivity extends AppCompatActivity implements MainView{
    ...
    @Override
    public void switch2Weater() {
        getSupportFragmentManager().beginTransaction().replace(R.id.frame_content, new WeaterFragment()).commit();
